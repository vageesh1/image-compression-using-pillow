...
#function for getting the size of the image 
...
def compress_image(image_name,new_size_ratio=0.9,quality=90, width=None, height=None, to_jpg=True):
    # open the image
    img = Image.open(image_name)
    # prining the original size of image
...
#function for taking the input in the command prompt
if __name__ == "__main__":
    ...
    print("="*50)
    # compress the image
    compress_image(args.image, args.resize_ratio, args.quality, args.width, args.height, args.to_jpg)
